                            ...
                            <div class="form-group row align-items-center justify-content-between">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" id="search" class="form-control me-1" name="search" placeholder="Chercher un utilisateur" value="{{ request('search') }}">
                        ...
                        <table class="table table-striped">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">@sortablelink('username', 'Pseudo')</th>
