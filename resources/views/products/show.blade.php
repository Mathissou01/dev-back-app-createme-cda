...
@push('page-styles')
    {{-- Ajouter les styles spécifiques ici --}}
@endpush
            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        <!-- Product image -->
                        <img class="img-account-profile mb-2" src="{{ $product->product_image }}" alt="" id="image-preview" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1">Code produit</label>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="small mb-1">Produit visible sur le magasin</label>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="list-group">
                                @if (is_array($product->materials) || is_object($product->materials))
                                ...
                                @else
                                    ...
                                    <li class="list-group-item">Données non valides pour les matériaux du produit</li>
                                @endif
                            </ul>
                        </div>
...
@push('page-scripts')
    {{-- Ajouter les scripts spécifiques ici --}}
@endpush
